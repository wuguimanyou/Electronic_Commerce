...
$query = "select batchcode from weixin_commonshop_orders where isvalid=true and paystatus=1 and status!=-1 and sendstatus=0 and customer_id=".$customer_id." and user_id=".$user_id." group by batchcode desc limit ".$order_num;	//获取订单号
...
<body id="mainBody" data-ctrl=true>
    <div id="mainDiv">
	  <!--   <header data-am-widget="header" class="am-header am-header-default">
		...
		<div id="middle-tab" class="tabbar">
			...
			<div id="kindDaiFaHuo" class="area-one select">
                <img src="./images/order_image/icon_daifahuo_sel-orange.png" width="20" height="20">
                <div>待发货</div>
            </div>
            ...
            <div class="entry-content">
				...
				?>
					...
					<?php
						$totalcount = 0;		//商品总数量
						$totalprice = 0;		//商品总价格
						$query3 = "select pid,rcount,totalprice,prvalues from weixin_commonshop_orders where isvalid=true and customer_id=".$customer_id." and user_id=".$user_id." and batchcode=".$batchcode." and paystatus=1 and status!=-1 and sendstatus=0";
	...
	<!-- 加载数据 -->
    <div id="jiazai">
		<div id="foo" onclick="get_orders('daifahuo')"></div>
	</div>
	<!-- 加载数据 -->
