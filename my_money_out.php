...
<style>
	.my_info{width:100%;height:60px;line-height:60px;background-color:white;padding-left:10px;border-bottom:1px solid #eee;font-size: 0;}
	...
	.left{float:left;color:black;float: left;text-align: left;}
    .danshel{width: 45.3%;overflow: hidden;text-align: left;white-space: nowrap;font-size: 14px;margin-left: 3%;}
    .left span{color:#707070;}
	.right{float:right;color:black;text-align:right;padding-right:20px;}
	.beizhu{border-bottom:none;height:auto;min-height: 50px;line-height:50px;}
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            var content='';
                ...
                content += '    <div class="left danshel"><span>出账'+money_name+'</span></div>';
