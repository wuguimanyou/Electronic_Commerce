...
$query = "select batchcode from weixin_commonshop_orders where isvalid=true and paystatus=0 and status!=-1 and customer_id=".$customer_id." and user_id=".$user_id." group by batchcode desc limit ".$order_num;	//获取订单号
...
<body id="mainBody" data-ctrl=true>
    <div id="mainDiv">
		...
		<div id="middle-tab" class="tabbar">
			...
			<div id="kindDaiFuKuan" class="area-one select">
                <img src="./images/order_image/icon_daifukuan_sel-orange.png" width="20" height="20">
                <div>待付款</div>
            </div>
            ...
            <div class="entry-content">
				...
				?>
					...
					<?php
						$totalcount = 0;		//商品总数量
						$totalprice = 0;		//商品总价格
						$query3 = "select pid,rcount,totalprice,prvalues from weixin_commonshop_orders where isvalid=true and customer_id=".$customer_id." and user_id=".$user_id." and batchcode=".$batchcode." and paystatus=0 and status!=-1";
	...
	<!-- 加载数据 -->
	<div id="jiazai">
		<div id="foo" onclick="get_orders('daifukuan')"></div>
	</div>
	<!-- 加载数据 -->
