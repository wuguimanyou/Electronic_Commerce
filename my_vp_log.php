...
$type       = "";//来源
$remark     = "";//备注
$query = "select status,createtime,batchcode,type,vp,remark from weixin_commonshop_vp_logs where isvalid=true and user_id=".$user_id." and customer_id=".$customer_id." and id=".$id;
...
<body data-ctrl=true style="background:#f8f8f8;">
    ...
    <div class="my_info">
        <div class="left" ><span>VP数值</span></div>
    	<div class="right" ><span class="red"><?php echo $vp;?></span></div>
    </div>
    <div class="container">
    	<div class="detail">
    	...
    	<div class="detail">
        	<div class="detail_left"><span>来源</span></div>
